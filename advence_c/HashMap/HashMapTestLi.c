...
UNIT(error_tests)
	...
	map = HashMap_Create(0, HashFunc1, EqualityFunc1);
	ASSERT_THAT(map == NULL);
	
	map = HashMap_Create(4, NULL, EqualityFunc1);
	ASSERT_THAT(map == NULL);
	
	map = HashMap_Create(3, HashFunc1, NULL);
	ASSERT_THAT(map == NULL);
	

	map = HashMap_Create(7, HashFunc1, EqualityFunc1);
