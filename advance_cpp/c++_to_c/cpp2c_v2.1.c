...
//  Task:
//     translate this to C the way the first C++ compilers did (cfront)
...
*/
typedef int(*dumb)(int);
typedef void(*colorFunc)(ColorEnum);
typedef enum ColorEnum { RED, GREEN, DEFAULT }ColorEnum;
static 	const char * pallete[] = { "\x1B[31m", "\x1B[32m", "\033[0m" };
/*
